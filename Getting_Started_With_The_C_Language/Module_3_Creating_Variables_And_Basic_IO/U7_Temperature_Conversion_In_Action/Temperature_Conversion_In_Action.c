...
int main(void)
{
    ...
    */
    ...
    //
    //  Notice how we've prefixed a .2 onto the specifier. For float specifiers, this tells
    //  The C compiler that we want out input to be rounded to 2 decimal places.
    //  Now run the program and see what happens!
    printf("\nThe Corresponding Temperature In Celcius Is %.2f C. \n", temperatureC);
    return 0;
}